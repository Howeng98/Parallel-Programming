...
int main(int argc, char **argv) {
  ...
  unsigned char *host_t = (unsigned char*)malloc(sizeof(unsigned char) * height * width * channels);
  unsigned char *d_src;
  unsigned char *d_dst;
  ...
  cudaMalloc(&d_dst, height * threads * width * channels * sizeof(unsigned char));
